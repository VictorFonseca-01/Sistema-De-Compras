...
Locator: getByText(/Auditoria Técnica|TI/i)
Expected: visible
Error: strict mode violation: getByText(/Auditoria Técnica|TI/i) resolved to 3 elements:
...
Call log:
  ...
  - waiting for getByText(/Auditoria Técnica|TI/i)
