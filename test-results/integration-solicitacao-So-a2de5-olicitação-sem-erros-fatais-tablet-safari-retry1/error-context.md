...
- Name: integration\solicitacao.spec.ts >> Solicitação (Integração) >> deve navegar para nova solicitação sem erros fatais
- Location: tests\e2e\integration\solicitacao.spec.ts:10:3
