...
- Name: integration\conclusao.spec.ts >> Conclusão e Anexos (Integração) >> deve validar blocos operacionais na conclusão
- Location: tests\e2e\integration\conclusao.spec.ts:4:3
...
Call log:
  - navigating to "http://localhost:5173/solicitacoes", waiting until "load"
